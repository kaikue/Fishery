...
@Config(modid = Fishery.MODID, name = Fishery.MODID, category = "")
public class FisheryConfig {
	...
	private static class EventHandler {
		...
		public static void onConfigChanged(ConfigChangedEvent.OnConfigChangedEvent event) {
			if (event.getModID().equals(Fishery.MODID)) {
				ConfigManager.sync(Fishery.MODID, Config.Type.INSTANCE);
			}
		}
	}
}
